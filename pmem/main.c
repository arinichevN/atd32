...
PMEMCHANNEL_DEF_GET_FIELD_FUNC(time_on_s, unsigned long)
PMEMCHANNEL_DEF_GET_FIELD_FUNC(time_off_s, unsigned long)
PMEMCHANNEL_DEF_GET_FIELD_FUNC(interval_on_s, unsigned long)
PMEMCHANNEL_DEF_GET_FIELD_FUNC(interval_off_s, unsigned long)

PMEMCHANNEL_DEF_SET_FIELD_FUNC(id, int)
PMEMCHANNEL_DEF_SET_FIELD_FUNC(pin, int)
PMEMCHANNEL_DEF_SET_FIELD_FUNC(time_on_s, unsigned long)
PMEMCHANNEL_DEF_SET_FIELD_FUNC(time_off_s, unsigned long)
PMEMCHANNEL_DEF_SET_FIELD_FUNC(interval_on_s, unsigned long)
PMEMCHANNEL_DEF_SET_FIELD_FUNC(interval_off_s, unsigned long)
