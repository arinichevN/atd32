...
void pmem_toChannel(Channel *channel, PmemChannel *pchannel){
	...
	channel->pin = pchannel->pin;
	channel->dtimer.time_on = pchannel->time_on;
	channel->dtimer.time_off = pchannel->time_off;
	channel->ptimer.interval_on = pchannel->interval_on;
	channel->ptimer.interval_off = pchannel->interval_off;
}

void pmem_fromChannel(PmemChannel *pchannel, Channel *channel){
	pchannel->id = channel->id;
	pchannel->enable = channel->enable;
	pchannel->pin = channel->pin;
	pchannel->time_on = channel->dtimer.time_on;
	pchannel->time_off = channel->dtimer.time_off;
	pchannel->interval_on = channel->ptimer.interval_on;
	pchannel->interval_off = channel->ptimer.interval_off;
}
...
PMEMCHANNEL_DEF_GET_FIELD_FUNC(time_on, unsigned long)
PMEMCHANNEL_DEF_GET_FIELD_FUNC(time_off, unsigned long)
PMEMCHANNEL_DEF_GET_FIELD_FUNC(interval_on, unsigned long)
PMEMCHANNEL_DEF_GET_FIELD_FUNC(interval_off, unsigned long)


PMEMCHANNEL_DEF_SET_FIELD_FUNC(id, int)
PMEMCHANNEL_DEF_SET_FIELD_FUNC(pin, int)
PMEMCHANNEL_DEF_SET_FIELD_FUNC(time_on, unsigned long)
PMEMCHANNEL_DEF_SET_FIELD_FUNC(time_off, unsigned long)
PMEMCHANNEL_DEF_SET_FIELD_FUNC(interval_on, unsigned long)
PMEMCHANNEL_DEF_SET_FIELD_FUNC(interval_off, unsigned long)
